...
Message = '"Welcome to the Anima training program"'
Message = '"Please take 30 seconds to relax and let your brain waves stabilize"'
Message = '"Begin relaxation"'

pause(30)

Message = '"End relaxation... PANIC MODE ENGAGED!!!"'

pause(10)

Message = '"Now relax and focus on the screen while keeping both your hands relaxed for 30 seconds"'

Message = '"Start:"'
calm = train(30);
Message = '"End"'

Message = '"Now imagine opening and closing your right fist at the speed of about one cycle per second"'

Message = '"Start:"'
right = train(30);
Message = '"End"'

Message = '"Now imagine opening and closing your left fist at the speed of about one cycle per second"'
...
function ret = train(endTime)
    ...
    for i = 1:endTime
        ...
        ret(i) = [AlphaAvr1, AlphaAvr2, AlphaMin1, AlphaMin2, P11(9:14), P12(9:14)]
    end
end